...
// commentService.create(new CommentEntity(null, ae1, ue1, "Digital disigne and
// very hipe house", null));
// commentService.create(
// new CommentEntity(null, ae1, ue2, "Maybe is cool, but i don`t like this
// aria", null));
...
// final CommentEntity newEntity = commentService.update(3L, new
// CommentEntity(null,
